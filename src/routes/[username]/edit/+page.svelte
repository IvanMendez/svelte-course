<script lang="ts">
    ...
    {#if $userData?.username == $page.params.username}
      ...
      <div class="text-center my-4">
        <a class="btn btn-outline btn-xs" href={`/${$userData.username}/photo`}>Actualizar foto</a>
      ...
      <SortableList list={$userData?.links} on:sort={sortList} let:item let:index>
        <div class="group relative">
          ...
          <button
            ...
            class="btn btn-xs btn-error invisible group-hover:visible transition-all absolute -right-6 bottom-10">Delete</button>
        </div>
      </SortableList>
